        ...
        <div className="relative h-full">
          ...
          >
            {cards.map((card, index) => (
              <div
                key={index}
                className="carousel-card flex-col items-center px-64"
              >
                <Card className="bg-purple-200">
                  ...
                  <div className="flex-col items-center">
                    <a
                      ...
                      className="inline-flex justify-center items-center mt-4 py-3 px-5 text-base font-large text-center text-[#4700C6] rounded-xl bg-[#FFE873]"
                    >
                      <Button
                        variant="text"
