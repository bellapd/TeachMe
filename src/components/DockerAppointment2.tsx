...
function Appointment() {
  ...
  const updateMetadata = async () => {
    ...
    if(cour === undefined){
      const data = { courses: {"docker": [[getFormattedDate(), selectedTime, "Hendra", "docker"]]}};
      ...
      const course = {"c": [[getFormattedDate(), selectedTime, "Hendra", "docker"]]};
      ...
      const data = { courses: {docker : cour2} };
