  ...
  return (
    <div id="Success-jumbo" className="h-screen bg-white">
      <div className="grid grid-cols-2 bg-transparent h-full">
        <div
          id="leftside"
          className="bg-white flex-1 flex items-center justify-center"
        >
        ...
        <div
          id="rightside"
          className="bg-white flex-1 flex items-center justify-center text-left"
        >
          <div className="text-left">
            <p className="font-bold text-4xl text-green-500 my-2">
              Appointment Successful !
            </p>
            <p className="text-2xl text-black font-thin my-2">
              Your mentor will reach out shortly.
            </p>
            <p className="bold text-2xl text-black my-2">
