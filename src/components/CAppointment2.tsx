...
function Appointment() {
  ...
  const updateMetadata = async () => {
    ...
    if (cour === undefined) {
      const data = { courses: { "c": [[getFormattedDate(), selectedTime, "Philip Aleon", "c"]] } };
      ...
      const course = { "c": [[getFormattedDate(), selectedTime, "Philip Aleon", "c"]] };
      ...
      const course = [[getFormattedDate(), selectedTime, "Philip Aleon", "c"]];
