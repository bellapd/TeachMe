        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-[#F6F4FC] rounded-lg p-8 md:p-12 items-center justify-center text-center">
                    ...
                    <a  href="https://discord.gg/vwXs54Y3sG">
                    <Button>
                ...
                <div className="bg-[#F6F4FC] rounded-lg p-8 md:p-12 items-center justify-center text-center">
                    ...
                    <div className="h-64">
                    <p className="font-normal text-gray-700 my-5 text-2xl">
                        The list of C language-learning resource include interactive courses, the best C++ tutorials.</p>
                    </div>
                    <div>
                    <h5 className="my-5 text-2xl font-bold tracking-tight text-gray-900">
                        C
                ...
                <div className="bg-[#F6F4FC] rounded-lg p-8 md:p-12 items-center justify-center text-center">
                    ...
                    <div className="h-64">
                    <p className="font-normal text-gray-700 my-5 text-2xl">
                        This is the place where Python Engineers level up their knowledge, skills, and network. Exchange technical publications, coding tutorials.</p>
                    </div>
                    <div>
                    <h5 className="my-5 text-2xl font-bold tracking-tight text-gray-900">
                        Python
